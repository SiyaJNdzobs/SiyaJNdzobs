...
My development focus includes and not limited to:
...
## 💻 Technical Stack & Learning Focus
...
- VS Code
- NetBeans
- Visual Studio 2022 (VB)
- Android Studio
- Jupiter notebook 
- Android & iOS Emulators  
- CI/CD (GitHub Actions — currently implementing in projects)
...
- Think in systems and operational logic  

These skills now directly support how I design and structure software projects.
...
IT Project Management: Module - Project Annual Project: eRank (work in progress) and Human Computer Interaction Semester Project (Analyse and enhance existing interface and intercation design of My CoE App an EKurhuleni Municipality billing system and water management system)
